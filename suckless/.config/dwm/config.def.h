...
static const Rule rules[] = {
	...
	{ "com.github.th_ch.youtube_music", NULL, NULL,           0,            1,          0,          0,         -1,      -1,     -1,     1200,     800,     -1 },
...
static const Key keys[] = {
  ...
  // { MODKEY,                       XK_n,      spawn,          {.v = filemanagerAlt } },
  ...
  // Volume Keys 
	{ 0,                            XF86XK_AudioRaiseVolume,  spawn,  SHCMD("pamixer --allow-boost -i 3 && ~/.dwm/scripts/notify-progress audio") },
	{ 0,                            XF86XK_AudioLowerVolume,  spawn,  SHCMD("pamixer --allow-boost -d 3 && ~/.dwm/scripts/notify-progress audio") },
	{ 0,                            XF86XK_AudioMute,         spawn,  SHCMD("pamixer -t && ~/.dwm/scripts/notify-progress muted") },
  { MODKEY|Mod1Mask,              XK_F9,                    spawn,  SHCMD("pactl set-source-mute @DEFAULT_AUDIO_SOURCE@ toggle") },

  // Brighntess Keys
  { 0,                            XF86XK_MonBrightnessUp,   spawn,  SHCMD("brightnessctl s 5%+ && ~/.dwm/scripts/notify-progress brightness") },
  { 0,                            XF86XK_MonBrightnessDown, spawn,  SHCMD("brightnessctl s 5%- && ~/.dwm/scripts/notify-progress brightness") },
  ...
  // Rofi Scripts 
  { MODKEY|Mod1Mask,              XK_f,                  spawn,  SHCMD("rofi -show find -modi find:~/.config/scripts/rofifinder &") },
  { MODKEY|ControlMask,           XK_f,                  spawn,  SHCMD("~/.config/scripts/rofifm &") },
  { MODKEY|Mod1Mask,              XK_p,                  spawn,  SHCMD("~/.config/scripts/rofi-pass-xorg &") },
  { MODKEY|ShiftMask,             XK_a,                  spawn,  SHCMD("~/.config/scripts/script &") },
  { MODKEY,                       XK_v,                  spawn,  SHCMD("rofi -modi 'clipboard:/home/karna/.local/bin/greenclip print' -show clipboard -run-command '{cmd}'") },
  { MODKEY|ShiftMask,             XK_o,                  spawn,  SHCMD("~/.dwm/scripts/ocr-script &> /tmp/ocr-file.log #&& notify-send 'OCR script' 'select text to be copied'") },
  { MODKEY|ShiftMask,             XK_e,                  spawn,  SHCMD("~/.config/rofi/applets/bin/emoji.sh &") },
  { MODKEY,                       XK_F7,                 spawn,  SHCMD("~/.dwm/scripts/drecord &") },
  { MODKEY|ShiftMask,             XK_p,                  spawn,  SHCMD("~/.config/rofi/powermenu/type-4/powermenu.sh &") },
};
